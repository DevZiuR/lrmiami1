            ...
            <div className="space-y-12">
              <div className="space-y-8">
                ...
                <div className="space-y-6">
                  <a href="tel:+13059048151" className="flex items-center space-x-4 text-gray-300 hover:text-gold-1 transition-colors duration-300">
                    <Phone className="w-6 h-6 text-[#D4AF37]" />
                    <span className="text-lg">+1 (305) 904-8151</span>
                  </a>
                  
                  <a href="mailto:LRmiamiLLC@gmail.com" className="flex items-center space-x-4 text-gray-300 hover:text-gold-1 transition-colors duration-300">
                    <Mail className="w-6 h-6 text-[#D4AF37]" />
                    <span className="text-lg">LRmiamiLLC@gmail.com</span>
                  </a>

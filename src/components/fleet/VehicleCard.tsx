  ...
  return (
    ...
    >
      ...
      <div className="p-6">
        ...
        <div className="flex items-center justify-between mb-4 text-sm">
          {vehicle.power_hp && (
            <div className="text-center">
              ...
              <div className="text-steel-3 text-xs">HP</div>
            </div>
          )}
          ...
          {vehicle.seats && (
            <div className="text-center">
              <div className="text-lg font-bold text-white">{vehicle.seats}</div>
              <div className="text-steel-3 text-xs">Seats</div>
            </div>
          )}
        </div>
        ...
        <Link to={`/fleet/${vehicle.id}`} onClick={(e) => e.stopPropagation()}>
